' VbCal0: Our starting point to demonstrate how to override members
...
' This is a new namespace. Our task is to re-use VBLog and override the
' List operation to do something more interesting.
